...
public class CucumberDemoSteps {
    ...
    @When("User enter test test@test.com to email field")
    public void user_enter_test_test_test_com_to_email_field() {

    }
    @Then("User should be not able")
    public void user_should_be_not_able() {
